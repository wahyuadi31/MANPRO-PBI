...
<body id="page-top">
  ...
  <nav id="mainNav" class="navbar navbar-default navbar-fixed-top absolute-wrapper">
    ...
    <footer class="page-footer padding margin container-fixed " style="background-color: #F05F40">
  		<div class="container">
  			<div class="row">
