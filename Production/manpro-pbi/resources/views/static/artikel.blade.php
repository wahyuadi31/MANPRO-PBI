...
<body id="page-top">
        ...
        <div class="container">
            <div class="row hide-on-small-only valign-wrapper">
                ...
                <div class="col-md-6 offset-m2 valign jarak-kanan">
                    <h2>Discover Trips,<br>Effortlessly</h2>
    ...
    <section id="about">
        <div class="container">
            <div class="row hide-on-small-only valign-wrapper">
                <div class="col-md-6 offset-m2 valign jarak-kiri">
                    <h2>Discover Trips,<br>Effortlessly</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    ...
                    <a href="#" class="btn btn-primary btn-xl page-scroll col-xs-6 col-centered col-min">Read ...</a>
                
                </div>
                <div class="col-md-6">
                    <div class="mockup jarak-kanan">
                        <img class="responsive-img" src="img/portfolio/1.jpg" style="width: 100%; height: 100%" alt="Discover mockup">
                    </div>
                </div>
